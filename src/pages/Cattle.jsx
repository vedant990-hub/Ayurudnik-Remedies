        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[400px]">
              <img 
                src="https://images.pexels.com/photos/235529/pexels-photo-235529.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                alt="Commercial cattle farming operations"
