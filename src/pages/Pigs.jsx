...
export const Pigs = () => {
  ...
  const supplements = [
    {
      name: 'Electrolytes',
      description: 'Supports fluid and salt balance during diarrhea, transport stress, or hot weather, helping restore hydration and acid–base balance.'
    },
    {
      name: 'Anti-Streptococcal Support',
      description: 'Supports resistance in young piglets and helps manage streptococcal pressure using plant extracts, zinc, and organic acids.'
    },
    {
      name: 'Heat Stress Support',
      description: 'Helps pigs cope with high temperatures by supporting electrolyte balance, water uptake, and antioxidant protection.'
    },
    {
      name: 'Respiratory Support (Breathing)',
      description: 'Supports the respiratory system during housing changes, transport, or periods of increased infection pressure.'
    },
    {
      name: 'Vitamin E / Selenium',
      description: 'Strengthens natural immunity, supports muscle metabolism and fertility, and is essential during stress, vaccination, or rapid growth.'
    },
    {
      name: 'Custom Pig Formula',
      description: 'A fully tailored feed supplement developed to address specific pig health or performance challenges.'
    }
  ];

  return (
    <div data-testid="pigs-page">
      {/* WhatsApp Modal */}
      {showWhatsAppModal && (
      ...
      <section className="py-16 md:py-20 lg:py-24 bg-white" data-testid="pigs-header">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-zinc-500 font-semibold mb-8">
                Private label nutritional supplements for pigs
              </p>
              <p className="text-sm sm:text-base md:text-lg text-zinc-600 leading-relaxed">
                Ayurudnik Remedies develops targeted nutritional supplement solutions for pigs, supporting health, resilience, and performance across different production stages and farming conditions.
              </p>
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 mt-8">
                <Link
                  ...
                  aria-label="Contact us about swine supplements"
                >
                  Contact Us
                ...
                <button
                  ...
                  aria-label="Request swine supplement details via WhatsApp"
                >
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl font-medium text-[#0B0B0B] mb-12">
              Ayurudnik – Pig Nutritional Supplements
            </h2>
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-4xl">
            ...
            <h2 className="font-['Playfair_Display'] text-3xl sm:text-4xl md:text-5xl font-medium text-[#0B0B0B] mb-8 leading-tight">
              Custom Pig Supplement Solutions
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-zinc-600 leading-relaxed">
              In addition to standard formulations, Ayurudnik Remedies offers custom pig supplement development, allowing formulations to be adapted to farm conditions, production goals, and market requirements.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 lg:py-32 bg-[#0B0B0B] text-white relative overflow-hidden" data-testid="contact-section">
        <div className="absolute inset-0 opacity-30">
          <img 
            src="/pigCTA.png"
            alt="Pig nutrition and supplement solutions"
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl">
            <h2 className="font-['Playfair_Display'] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium mb-6 sm:mb-8 leading-tight">
              Discuss Your Pig Supplement Needs
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-zinc-300 mb-8 leading-relaxed">
              Contact Ayurudnik Remedies to learn more about our pig supplement portfolio or to develop a custom solution for your operation.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link
                ...
                aria-label="Contact us about pig supplements"
              >
                Contact Us
                <ArrowRight size={16} strokeWidth={2} />
              </Link>
